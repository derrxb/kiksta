...
export default function Home() {
  return (
    <>
        ...
        <div className="container relative z-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          <div className="flex flex-col gap-6 lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl lg:text-2xl font-medium text-zinc-300 max-w-[600px] mx-auto lg:mx-0">
              Whether you&apos;re chasing a 5K PR or conquering your first mile,
              you showed up when others did&apos;nt. Now let&apos;s turn that
              dedication into data and stories that inspire.
            </p>
      ...
      {/* Features Section */}
      <section id="features" className="py-16 lg:py-24 bg-zinc-900 w-full">
        <div className="container flex-1 px-4 md:px-8 lg:px-16 mx-auto">
          <div className="text-center mb-12 lg:mb-20">
            ...
            <p className="text-xl text-zinc-400 max-w-[800px] mx-auto font-medium">
              From weekend warriors to elite athletes. Every pace has potential.
              Every goal deserves the right tools.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-black p-8 lg:p-10 rounded-2xl text-white shadow-2xl transform hover:scale-105 transition-transform duration-300 border-2 border-zinc-800">
              ...
              <p className="text-zinc-300 mb-6 text-lg font-medium">
                ...
                achieve. Whether you&apos;re running 5-minute miles or taking it
                steady, we&apos;ll show you exactly what&apos;s possible.
              </p>
              ...
              <div className="space-y-6 mb-10">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 font-medium">
                      From 5K sprints to ultra marathons. Every distance, every
                      challenge covered.
                    </p>
                  </div>
                </div>
      ...
      <section id="instagram" className="py-20 lg:py-32 bg-zinc-900 w-full">
        <div className="container flex-1 px-4 md:px-8 lg:px-16 mx-auto">
              ...
              <div className="bg-black rounded-2xl shadow-2xl overflow-hidden max-w-[320px] mx-auto border-4 border-zinc-800">
                ...
                <div className="relative">
                  ...
                  <div className="h-[520px] bg-black relative">
                    <Image
                      src="/venti-views-unsplash.jpg?height=520&width=320"
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 font-medium">
                      Templates designed to make your runs look as epic as they
                      felt.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 font-medium">
                      Generate and share in seconds. No design skills, just pure
                      bragging rights.
                    </p>
                  </div>
                </div>
